...
const KEY = 'catania-siracusa' as const;
const IT_PATH = '/transfer-catania-siracusa';
const EN_PATH = '/en/catania-syracuse-transfer';
const FR_PATH = '/fr/transfert-catane-syracuse';
    ...
    <>
      ...
      <JsonLd
        data={breadcrumbSchema(
          getBreadcrumb('transfer-catania-siracusa', locale as Locale, route.h1)
        )}
      />
