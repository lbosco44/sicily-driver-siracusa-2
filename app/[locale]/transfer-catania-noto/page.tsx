...
const KEY = 'catania-noto' as const;
const IT_PATH = '/transfer-catania-noto';
const EN_PATH = '/en/catania-noto-transfer';
const FR_PATH = '/fr/transfert-catane-noto';
    ...
    <>
      ...
      <JsonLd
        data={breadcrumbSchema(
          getBreadcrumb('transfer-catania-noto', locale as Locale, route.h1)
        )}
      />
