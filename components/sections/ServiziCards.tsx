...
export async function ServiziCards() {
  ...
  const cards: CardData[] = [
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1519225421980-715cb0215aed?w=1000&q=70&auto=format&fm=webp',
      layoutClass: 'lg:col-span-6 lg:row-span-1'
    }
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-5 lg:auto-rows-[260px]">
          {cards.map((card, i) => (
            <Link
              ...
              style={{color: 'inherit'}}
            >
              {/* Foto decorativa su layer separato — niente mixBlendMode (GPU-friendly) */}
              <div className="absolute inset-y-0 right-0 w-1/2 opacity-[0.18] lg:opacity-[0.22] pointer-events-none">
                <Image
                  ...
                  decoding="async"
                />
                <div className="absolute inset-0 bg-gradient-to-r from-current/40 via-current/15 to-transparent opacity-50" />
              </div>
              ...
              <div className="relative flex items-start justify-between gap-4">
                ...
                <p className="text-[10px] uppercase tracking-[0.14em] font-medium opacity-90 mt-3 max-w-[12ch] text-right">
                  {card.kicker}
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="mt-3 text-[14px] sm:text-[15px] leading-[1.55] opacity-95 max-w-[40ch]">
                  {card.body}
                </p>
