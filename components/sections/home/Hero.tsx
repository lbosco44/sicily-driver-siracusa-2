        ...
        >
          ...
          <div className="mt-4 sm:mt-5 flex flex-wrap items-center justify-center gap-3 sm:gap-4">
            <a
              ...
              className="group inline-flex items-center gap-3 rounded-full bg-canvas border border-[var(--border-strong)] px-4 py-2.5 transition-all duration-200 hover:shadow-md hover:border-accent/50"
            >
              {/* Logo Instagram a colori originali (gradiente brand) */}
              ...
              <span className="font-display font-medium text-[16px] sm:text-[17px] text-ink">Instagram</span>
            </a>
