    ...
    <header className="sticky top-0 z-40 bg-canvas/85 backdrop-blur-md border-b border-[var(--border)]/60">
      <div className="mx-auto max-w-(--container-editorial) px-6 sm:px-10 h-16 sm:h-20 grid grid-cols-[1fr_auto_1fr] items-center gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-6 justify-self-end">
          ...
          {/* Lingua: dropdown compatto su mobile (< md), 3 opzioni tap-friendly. */}
          ...
          {/* Contattaci: bottone rotondo solo-icona su mobile, pill con testo su desktop. */}
          <Link
            href="/contatti"
            ...
            className="
              ...
              size-11 md:size-auto md:px-5 md:py-2.5
